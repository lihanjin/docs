---
title: "OpenManus"
description: "Connect AllToken to OpenManus and run agentic tasks with an OpenAI-compatible model."
---
...
Make sure the model name in `config.toml` matches the name enabled in your AllToken account.
...
With AllToken, you can keep model access behind one gateway and choose the right model for each job.
