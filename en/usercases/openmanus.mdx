---
title: "OpenManus"
description: "Connect AllTokens to OpenManus and run agentic tasks with an OpenAI-compatible model."
---
...
Open the `config/config.toml` file and point the model settings to AllTokens.
...
With AllTokens, you can keep model access behind one gateway and choose the right model for each job.
