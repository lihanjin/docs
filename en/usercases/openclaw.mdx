...
description: "Connect AllToken to OpenClaw as a custom OpenAI-compatible provider."
---
...
With AllToken, you can point OpenClaw to a unified OpenAI-compatible gateway and manage models and API keys centrally.
...
- Replace `glm-4` with any model that is enabled in your AllToken account.
