...
description: "Connect AllTokens to OpenCode through a custom OpenAI-compatible provider."
---
...
With AllTokens, you can route OpenCode requests through a single gateway and manage API keys, models, and quotas in one place.
