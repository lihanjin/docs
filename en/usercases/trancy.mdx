---
title: "Use in Trancy"
description: "Connect AllTokens to Trancy as the model backend for translation workflows."
---
...
With AllTokens, you can use one API key, one base URL, and flexible model routing.
