...
description: "將 Hubto 作為 OpenClaw 的自訂 OpenAI 相容提供方接入。"
---
...
- 基礎地址請使用 `https://hubto.ai/v1`
- 將 `glm-4` 替換成你在 Hubto 中已開通的模型名稱
- 如果你偏好手動設定，也可以在 `models.providers` 中新增自訂 provider，並把預設模型設為 `hubto/glm-4`
