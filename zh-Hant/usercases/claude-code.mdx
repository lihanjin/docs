...
description: "將 AllToken 接入 Claude Code，透過統一網關調用 Claude 系列模型。"
---
...
透過接入 AllToken，你可以把 Claude Code 的請求統一走 AllToken 網關，方便集中管理 API Key、模型權限、額度與路由策略。
...
- 請先確認你的 AllToken 金鑰已開通 Claude 相關模型。
